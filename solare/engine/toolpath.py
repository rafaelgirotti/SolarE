...
which writes proper registry entries under HKCU/SOFTWARE/VapourSynth), not just being on PATH.
Install it - and its chunking plugins (L-SMASH/FFMS2/BestSource) - per av1an's own installation
instructions (https://github.com/rust-av/Av1an#installation), not by copying files here.
"""
